...
export default function App() {
  ...
  const LibraryPage = () => (
    <>
      ...
      {!isPremium&&<div className="upgrade-banner"><div className="upgrade-text"><h3>{IS_DEMO?'🚀 Full app coming soon':t.unlockTitle}</h3><p>{IS_DEMO?'You’re exploring an early preview of House of Books.':t.unlockDesc}</p></div>{!IS_DEMO&&<button className="btn-premium" onClick={()=>{track('upgrade_click');setShowPaymentModal(true)}}>{t.startFor}</button>}</div>}
  ...
  <div className="app-root">
    ...
    <header className="app-header">
      ...
      <div className="header-right">
        ...
        {IS_DEMO&&<span className="btn-premium" style={{cursor:'default',opacity:0.85}}>Coming soon</span>}
      </div>
    </header>
