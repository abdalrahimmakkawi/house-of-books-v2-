...
export default async function handler(req, res) {
  ...
  // The marketing site (houseofbooks.site) is a separate origin and also
  // submits feedback here. 'list' stays safe cross-origin since it's
  // independently gated on an admin access token, not on request origin.
